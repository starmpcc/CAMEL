...
In response to the growing demand for privacy-preserving AI solutions in healthcare, we release **CAMEL-7B**, a new clinical large language model that has been further pretrained with clinical notes (3.4B tokens) and fine-tuned on 100K clinical instructions over [LLaMa](https://arxiv.org/abs/2302.13971) (Figure 2). Our results show that **CAMEL-7B** can achieve similar performance (96% score measured by GPT4) to GPT-3.5 on 13 tasks over previously unseen clinical notes.
